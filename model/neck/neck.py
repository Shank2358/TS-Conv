...
from ..layers.multiscale_fusion_blocks import SPPF
...
class Neck(nn.Module):
    def __init__(self, fileters_in, fileters_in_ratio = 1):
        ...
        #self.down = Convolutional(filters_in=fi_2,0* filters_out=fi_0, kernel_size=3, stride=1, pad=1, norm="bn", activate="leaky")
        ...
        self.__conv_set_0 = nn.Sequential(
            Convolutional(filters_in=fi_0 * fileters_in_ratio, filters_out=fi_1, kernel_size=1, stride=1, pad=0, norm="bn",
                          activate="leaky"),
            SPPF(fi_1),
            Convolutional(filters_in=fi_1, filters_out=fi_0, kernel_size=3, stride=1, pad=1, norm="bn",
                          activate="leaky"),
            Convolutional(filters_in=fi_0, filters_out=fi_1, kernel_size=1, stride=1, pad=0, norm="bn",
                          activate="leaky"),
        ...
        self.__conv01up = Convolutional(filters_in=fi_1, filters_out=fi_2, kernel_size=1, stride=1, pad=0, norm="bn",
                                        activate="leaky")
        self.__upsample0 = Upsample(scale_factor=2)
        self.__route01 = Route()
        #######################################################################################
        self.__conv_set_1 = nn.Sequential(
            Convolutional(filters_in=fi_1 * fileters_in_ratio + fi_2, filters_out=fi_2, kernel_size=1, stride=1, pad=0, norm="bn",
                          activate="leaky"),
            Convolutional(filters_in=fi_2, filters_out=fi_1, kernel_size=3, stride=1, pad=1, norm="bn",
                          activate="leaky"),
            Convolutional(filters_in=fi_1, filters_out=fi_2, kernel_size=1, stride=1, pad=0, norm="bn",
                          activate="leaky"),
            # LinearScheduler(DropBlock2D(block_size=3, drop_prob=0.1), start_value=0., stop_value=0.1, nr_steps=5),
            Convolutional(filters_in=fi_2, filters_out=fi_1, kernel_size=3, stride=1, pad=1, norm="bn",
                          activate="leaky"),
        ...
        self.__conv12up = Convolutional(filters_in=fi_2, filters_out=fi_3, kernel_size=1, stride=1, pad=0, norm="bn",
                                        activate="leaky")
        self.__upsample1 = Upsample(scale_factor=2)
        self.__route12 = Route()
        ########################################################################################
        self.__conv_set_2 = nn.Sequential(
            Convolutional(filters_in=fi_2 * fileters_in_ratio + fi_3, filters_out=fi_3, kernel_size=1, stride=1, pad=0, norm="bn",
                          activate="leaky"),
            Convolutional(filters_in=fi_3, filters_out=fi_2, kernel_size=3, stride=1, pad=1, norm="bn",
                          activate="leaky"),
            Convolutional(filters_in=fi_2, filters_out=fi_3, kernel_size=1, stride=1, pad=0, norm="bn",
                          activate="leaky"),
